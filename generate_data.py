...
GENERATION_ITEMS: List[Dict] = [
    # emotion_text drives the emotion extractor; prompt is the LLM input
    {"prompt": "Tell me about the weather today.",
     "emotion_text": "I am so happy and excited!",
     "target_emotion": "joy"},
    {"prompt": "What should I have for dinner?",
     "emotion_text": "I feel really sad and lonely tonight.",
     "target_emotion": "sadness"},
    {"prompt": "Explain how computers work.",
     "emotion_text": "This makes me furious and I can't stand it!",
     "target_emotion": "anger"},
    {"prompt": "Tell me a story about a cat.",
     "emotion_text": "I'm so grateful for everything you've done.",
     "target_emotion": "gratitude"},
    {"prompt": "What is the meaning of life?",
     "emotion_text": "I'm terrified of what might happen next.",
     "target_emotion": "fear"},
    {"prompt": "Describe a beautiful sunset.",
     "emotion_text": "I love you more than words can express.",
     "target_emotion": "love"},
    {"prompt": "How do airplanes fly?",
     "emotion_text": "I'm confused and don't understand anything.",
     "target_emotion": "confusion"},
    {"prompt": "What makes a good leader?",
     "emotion_text": "I feel so proud of what I've accomplished.",
     "target_emotion": "pride"},
    {"prompt": "Suggest a weekend activity.",
     "emotion_text": "I'm really disappointed with how things turned out.",
     "target_emotion": "disappointment"},
    {"prompt": "How does the internet work?",
     "emotion_text": "I'm so curious and want to learn everything!",
